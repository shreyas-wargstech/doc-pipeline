...
- **OCR cost optimization — IN PROGRESS.** FIX-047/047b fixed keyword coverage (blanks + letter_body + invoice rules). FIX-048 (2026-06-15): image resize for classify VLM (768px → 4–10× token reduction, $0.069→$0.007 estimated). Measurement pending live pipeline run to confirm savings.
